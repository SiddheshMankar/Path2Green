...
function AnimatedGlobe() {
  return (
    <div className="relative w-32 h-32  mx-[400px] mb-10 ">
...
export default function Home() {
  ...
  return (
    <div className={`container mx-auto px-4 py-16 ${poppins.className} overflow-x-hidden`}>
       <section className="text-center mx-[100px] mb-20">
        <AnimatedGlobe />
        <h1 className="text-6xl font-bold mb-6 mx- text-gray-800 tracking-tight">
          Path2Green <span className="text-green-600">Waste Management</span>
        </h1>
