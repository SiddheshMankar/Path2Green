...
export default function ReportPage() {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      const prompt = `You are an expert in waste management and recycling. Analyze this image and provide:
        ...
        4. An explanation of how you arrived at this conclusion
        Respond in JSON format like this:
        {
          ...
          "threatlevel": "threat level of the waste"
        }`;
      ...
      try {
        ...
        if (parsedResult.wasteType && parsedResult.quantity && parsedResult.confidence && parsedResult.Explanation) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setNewReport({ location: '', type: '', amount: '' ,Explanation:'',threatlevel:''});
      setFile(null);
      setPreview(null);
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <div className="mt-2 text-sm text-green-700">
                  ...
                  <p>Explanation:{(verificationResult.Explanation)}</p>
                  <p>Threat Level:{(verificationResult.threatlevel)}</p>
                </div>
              </div>
            </div>
          </div>
